...
def main():
    ...
    m.add_node(x=0,y=1, label="node3", restx=0,resty=0, loadx=10,loady=30,  use_grid=True)

    m.add_material("matrl_1_3", # human-readable material name
                    29000    # E, youngs modulus, ksi
                )
    m.add_material("matrl_2", 10000)
